 ...
 */
function gm_personal_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'gm_personal_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.gm_personal-front-page) .entry-title,
...
.colors-custom .gm_personal-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.gm_personal-front-page .panel-content .recent-posts article,
...
.colors-custom.gm_personal-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'gm_personal_custom_colors_css', $css, $hue, $saturation );
}
